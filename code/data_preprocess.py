...
# -------------数据切分------------
def data_split():
    with open('preprocessed_movie_lines.txt', 'r', encoding='utf-8') as fin, \
        open('movie_dialog_train.txt', 'w', encoding='utf-8') as f_train, \
        open('movie_dialog_val.txt', 'w', encoding='utf-8') as f_val, \
        open('movie_dialog_test.txt', 'w', encoding='utf-8') as f_test:
        data = fin.readlines()
